...
- Java 17 + Spring Boot 3.x (backend), TypeScript + Angular (frontend), Nginx 1.27 (proxy), Docker Compose v2 + Spring Security Bearer auth, PostgreSQL 15, Angular HttpClient interceptor, Nginx reverse proxy, Docker healthcheck (009-reverse-proxy-stack)
- PostgreSQL en contenedor `db` con volumen `postgres_data` (009-reverse-proxy-stack)
...
## Recent Changes
- 009-reverse-proxy-stack: Added Java 17 + Spring Boot 3.x (backend), TypeScript + Angular (frontend), Nginx 1.27 (proxy), Docker Compose v2 + Spring Security Bearer auth, PostgreSQL 15, Angular HttpClient interceptor, Nginx reverse proxy, Docker healthcheck
